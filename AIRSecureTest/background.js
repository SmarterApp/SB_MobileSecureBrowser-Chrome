...
chrome.app.runtime.onLaunched.addListener(function(launchData) {
  chrome.app.window.create(
	'main.html', 
	{ id: 'main', state: 'maximized' /*, alwaysOnTop: true*/},  // This config appears not to be working 
	function(appWindow){		
		...
		// we can set the webview's (contained in there) size properly to maximize screen realestate
